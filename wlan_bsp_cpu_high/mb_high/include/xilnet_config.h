...
// Ethernet device 0
#define ETH_B_MAC                                XILNET_ETH_0                  // External name of Ethernet device
#define XILNET_ETH_0                             0                             // Internal name of Ethernet device

#define XILNET_ETH_0_INF_DEVICE_ID               XPAR_ETH_B_FIFO_DEVICE_ID
#define XILNET_ETH_0_NUM_RECV_BUF                1
#define XILNET_ETH_0_BUF_SIZE                    1514

// Variables for ETH 0
extern XLlFifo              ETH_0_FIFO_Instance;

// Buffers for ETH 0
extern unsigned int recvBuffer_eth_0[XILNET_ETH_0_NUM_RECV_BUF*((XILNET_ETH_0_BUF_SIZE+3)/4)];
extern unsigned int sendBuffer_eth_0[(XILNET_ETH_0_BUF_SIZE+3)/4];


/************************* Ethernet 1 Definitions ****************************/

// Ethernet device 1
#define ETH_A_MAC                                XILNET_ETH_1                  // External name of Ethernet device
#define XILNET_ETH_1                             1                             // Internal name of Ethernet device

#define XILNET_ETH_1_INF_DEVICE_ID               XPAR_MB_HIGH_ETH_DMA_DEVICE_ID
#define XILNET_ETH_1_NUM_RECV_BUF                0
#define XILNET_ETH_1_BUF_SIZE                    0
#define XILNET_ETH_1_RXBD_CNT                    0                             // Number of RxBDs to use
#define XILNET_ETH_1_TXBD_CNT                    0                             // Number of TxBDs to use
#define XILNET_ETH_1_RXBD_SPACE_BYTES            0
#define XILNET_ETH_1_TXBD_SPACE_BYTES            0
