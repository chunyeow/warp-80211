...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = mb_high_data_bram_ctrl
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 3.01.a
 PARAMETER HW_INSTANCE = mb_high_dlmb_bram_cntlr
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 3.01.a
 PARAMETER HW_INSTANCE = mb_high_ilmb_bram_cntlr
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 3.01.a
 PARAMETER HW_INSTANCE = mb_high_init_data_ctrl
END
