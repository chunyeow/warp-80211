...
typedef struct {
    ...
    uint32_t TIMESTAMP_COUNTER_MSB;
    uint32_t TIMESTAMP_COUNTER_MSB_n_bits;
    uint32_t TIMESTAMP_COUNTER_MSB_bin_pt;
    // uint32_t TIMESTAMP_COUNTER_MSB_attr;
    uint32_t TIMESTAMP_COUNTER_LSB;
    uint32_t TIMESTAMP_COUNTER_LSB_n_bits;
    uint32_t TIMESTAMP_COUNTER_LSB_bin_pt;
    // uint32_t TIMESTAMP_COUNTER_LSB_attr;
